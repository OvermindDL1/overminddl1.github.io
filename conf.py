...
BLOG_AUTHOR = "OvermindDL1"  # (translatable)
BLOG_TITLE = "Hyperglot Programmer"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.overminddl1.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "overminddl1@overminddl1.com"
BLOG_DESCRIPTION = "My musings and experiments in programming and occasionally more."  # (translatable)
